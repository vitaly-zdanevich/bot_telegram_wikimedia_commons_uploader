...
Metadata and tracking links: [Commons project page](https://commons.wikimedia.org/wiki/Commons:Telegram_Commons_Uploader),
...
| `scripts/toolforge-code-deploy.sh` | Build with cached Ubuntu Rust Docker image, upload only the Toolforge Rust binary, and restart; skips Toolforge Aptfile/image rebuilds and leaves yt-dlp cookies unchanged |
